...
status: current
image: ../../images/projects/palimpzest/palimpzest.png
---
...
## Read Our Paper
[**Link to Paper**](https://arxiv.org/pdf/2405.14696)

#### Check Out the Colab Demo
[Colab Demo](https://colab.research.google.com/drive/1zqOxnh_G6eZ8_xax6PvDr-EjMt7hp4R5?usp=sharing)
...
### Semantic Analytical Applications (SAPPs)
...
![Figure with a positive and negative example from the Legal Discovery workload.](../../images/projects/palimpzest/enron-example.png)
<center>
<p>
...
![Figure with a positive and negative example from the Real Estate Search workload.](../../images/projects/palimpzest/real-estate-example.png)
<center>
<p>
...
![Figure illustrating the workflow for the Medical Schema Matching workload.](../../images/projects/palimpzest/biofabric_matching-small.png)
<center>
<p>
...
Taken together, these criteria outline a broad class of AI programs that are important, complex, and potentially very optimizable; we call them ***semantic analytical applications*** -- or, **SAPPs**. We believe there is a large set of such use cases that mix conventional data analytics with transformations and filters that would not be possible without AI methods. Such workloads frequently require interleaved data acquisition steps, conventional analytical queries, and AI operations. The AI operations process unstructured data, require broad domain knowledge to implement, or have specifications that users may not be able to implement correctly with traditional source code.
...
Our key insight is that machines, not human engineers, should decide how best to optimize semantic analytical applications. Engineers should be able to write AI programs at a high level of abstraction and rely on the computer to find an optimized implementation that best fits their use case. A similar set of circumstances -- a need for performance improvements for an important workload, during a time of enormous technical change -- led to the development of the relational database query optimizer in the 1970s. Today's underlying technical challenges are very different, but the basic idea of declarative program optimization remains valuable.
...
![Palimpzest system diagram.](../../images/projects/palimpzest/intro.png)
<center>
<p>
...
![Palimpzest results for all plans.](../../images/projects/palimpzest/all-plans.png)
<center>
<p>
...
![Palimpzest results for re-optimization.](../../images/projects/palimpzest/reopt.png)
<center>
<p>
...
![Palimpzest results for parallel speedup.](../../images/projects/palimpzest/speedup-small.png)
<center>
<p>
...
[Chunwei Liu*, Matthew Russo*, Michael Cafarella, Lei Cao, Peter Baille Chen, Zui Chen, Michael Franklin, Tim Kraska, Samuel Madden, Gerardo Vitagliano. A Declarative System for Optimizing AI Workloads](https://arxiv.org/pdf/2405.14696)

\* Denotes equal contribution.

<Bibtex>{`@misc{liu2024declarative,
      title={A Declarative System for Optimizing AI Workloads}, 
...
Chunwei Liu, Matthew Russo, Michael Cafarella, Peter Baille Chen, Zui Chen, Tim Kraska, Samuel Madden, Gerardo Vitagliano 
